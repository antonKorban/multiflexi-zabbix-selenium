...
describe('deshbordViewCompanies', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('deshbordViewCompanies', async function() {
    // Login first
    ...
    // Now test dashboard view companies
    ...
    await driver.findElement(By.id("viewcompaniesbutton")).click()
    
    // Wait for the table to load and select last company in list using CSS selector
    await driver.sleep(1000)
    const lastCompanyLink = await driver.wait(until.elementLocated(By.css("tbody tr:last-child a")), 5000)
    await lastCompanyLink.click()
  })
})
