...
describe('deshboardTodayJobs', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('deshboardTodayJobs', async function() {
    // Login first
    ...
    await driver.findElement(By.id("viewtodayjobsbutton")).click()
