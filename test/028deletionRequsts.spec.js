...
describe('deletionRequsts', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('deletionRequsts', async function() {
    // Login first
    ...
    await driver.findElement(By.linkText("🗑️ Deletion Requests")).click()
  })
})
