...
describe('environmentModules', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('environmentModules', async function() {
    // Login first
    ...
    await driver.findElement(By.linkText("🌦️ Environment Modules")).click()
  })
})
