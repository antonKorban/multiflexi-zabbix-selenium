...
describe('dataRetentialManagement', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('dataRetentialManagement', async function() {
    // Login first
    ...
    // Now test data retention management
    ...
    await driver.findElement(By.linkText("🗂️ Data Retention Management")).click()
  })
})
