...
describe('dashboardRunningJobs', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('dashboardRunningJobs', async function() {
    // Login first
    ...
    // Now test dashboard running jobs
    ...
    await driver.findElement(By.id("viewrunningjobsbutton")).click()
